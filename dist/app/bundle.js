...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reduxLogger = __webpack_require__(/*! redux-logger */ 6);
	...
	var mathReducer = function mathReducer() {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { // defining here it self with initial values
	        result: 1,
	        lastValues: [],
	        userName: "Marry"
	    };
	    var action = arguments[1];
	    // Here state will recieve the values from initialState if state is null, otherwise it will recieve the data from state if state is having any data.
	    switch (action.type) {
	        case "ADD":
	...
	var store = (0, _redux.createStore)((0, _redux.combineReducers)({ mathReducer: mathReducer, userReducer: userReducer }), {}, (0, _redux.applyMiddleware)(myLogger, (0, _reduxLogger2.default)())); //this is being used as key value pair as mathReducer: mathReducer, but because of ES6 syntak it can be shotened as mathReducer. Here two different states are being used as by mathReducer uses math State and userReducer uses user State
